...
data = pd.read_csv('Assam_Final.csv', na_values=['NA', 'NaN', 'N/A', 'nan', ''])
...
app.layout = html.Div([
    ...
    html.Div([
        html.Div([
            html.Img(src=app.get_asset_url('Assam_map__stations.png'),
                     style={'width': '650px', 'height': '600px', 'display': 'inline-block', 'margin-right': '50px',
        ...
        html.Div([
            ...
            html.H1('Assam Rainfall', style={'text-align': 'center', 'margin-top': '10px'}),
...
def render_content(tab):
    if tab == 'tab1':
        return html.Div([
            ...
            html.Div([
                html.Div([
                    html.H3('Bar-graph Rainfall Distribution of Assam State', style={
                        'text-align': 'center',
                        'display': 'flex',
            ...
            html.Div([
                html.Div([
                    html.H3('Bar-graph Rainfall distribution of Assam Districts', style={
                        'text-align': 'center',
                        'display': 'flex',
                        'justify-content': 'center',
                        'align-items': 'center',
    ...
    html.H4('This is Heatmap Monthly Distribution  of Assam State'),
    ...
    dcc.Graph(id='calendar-heatmap-weekly'),
        ...
        return html.Div([
            html.H3('Extreme Events of Assam State', style={'text-align': 'center'}),
        ...
        return html.Div([
            ...
            html.Div([
                html.Div([
                    html.H3('Percentage Distribution Of annual Rainfall in Assam', style={
                        'text-align': 'center',
                        'display': 'flex',
                        'justify-content': 'center',
                        'align-items': 'center',
...
def update_statewise_rainfall_graph(year_range):
    ...
    fig = px.bar(df, x='Day', y='Average Rainfall',
                 ...
                 title=f'Assam State Climatology from  - {start_year} to {end_year}',
...
def update_trend_chart(year_range):
    ...
    fig.update_layout(title=f'Station Rainfall Climatology in Assam from ({start_year} to {end_year})',
